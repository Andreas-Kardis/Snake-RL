...
pygame.init()
font = pygame.font.Font('/Users/andreaskardis/PycharmProjects/snakeGame/arial.ttf', 25)
...
class SnakeGameAI:
    ...
    def play_step(self, action):
        ...
        if self.head == self.food:
            ...
            reward = 10
            self._place_food()
        elif math.sqrt((self.head.x - self.food.x)**2 + (self.head.y - self.food.y)**2) < self.dist: # snake is closer to food
            reward = 1
            self.snake.pop()
        else: # snake is further away from food
            reward = -1
            self.snake.pop()
